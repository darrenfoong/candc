...
public class TrainViterbiAllInMemory {
	public static void main(String[] args) {
		if ( args.length < 5 ) {
			System.err.println("TrainViterbiAllInMemory requires 5 arguments: <forestFile> <weightsFile> <numIters> <fromSentence> <toSentence>");
			return;
		}
